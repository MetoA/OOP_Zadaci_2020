...
public:
    ...
    double voEvra(){
    	...
    	return (this->paricenIznos*USD)/EUR;
    }
    ...
    double voDolari(){
    	...
    	return (this->paricenIznos*EUR)/USD;
    }
...
public:
    ...
    void izvestajVoEvra(){
    	...
    	cout<<"Korisnikot so smetka: "<<brojSmetka<<" ima momentalno saldo od "<<sum<<" EUR"<<endl;
    }
    ...
    void izvestajVoDolari(){
    	...
    	cout<<"Korisnikot so smetka: "<<brojSmetka<<" ima momentalno saldo od "<<sum<<" USD"<<endl;
    }
