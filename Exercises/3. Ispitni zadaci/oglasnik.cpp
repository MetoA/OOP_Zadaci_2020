...
public:
  ...
  friend ostream &operator<<(ostream &stream, const Oglas &o){
    stream<<o.naslov<<endl;
    stream<<o.opis<<endl;
    stream<<o.cena<<" evra"<<endl;
...
bool operator>(const Oglas &o1, const Oglas &o2){
...
public:
  ...
  friend ostream &operator<<(ostream &stream, const Oglasnik &o){
    stream<<o.ime<<endl;

    for(int i = 0; i < o.brOglasi; i++){
      stream<<o.oglasi[i]<<endl;
    }
  ...
  void najniskaCena(){
    float najniskaCena = oglasi[0].getCena();
    int printI = 0;

    for(int i = 0; i < brOglasi; i++){
      if(oglasi[i].getCena() < najniskaCena){
        najniskaCena = oglasi[i].getCena();
        printI = i;
      }
    }

    cout<<oglasi[printI]<<endl;
  }
