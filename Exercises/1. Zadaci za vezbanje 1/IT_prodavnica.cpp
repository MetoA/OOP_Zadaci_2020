/*
ИТ продавница Problem 18 (2 / 2)
Во програмскиот јазик C или C++ да се креира структура Laptop за опишување на спецификациите на даден преносен компјутер. Структурата треба да содржи: (5 поени)
